...
module.exports = {
    ...
    resolve:{
        alias:{
            ...
            style_m:path.resolve(__dirname, 'app/css-min'),
            ...
            tableTool:path.resolve(__dirname, 'app/js/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min'),
            ...
            //app
            router: path.resolve(__dirname, 'app/js/routers/router'),
            ...
            TableAdvanced:path.resolve(__dirname, 'app/js/app/table-advanced'),
            CommonModule:path.resolve(__dirname, 'app/js/app/common-module'),
            ChartModule:path.resolve(__dirname, 'app/js/app/chart-module'),
            //views
            login:path.resolve(__dirname, 'app/js/views/login'),
            mainpage:path.resolve(__dirname, 'app/js/views/mainpage'),
            //widget
            util:path.resolve(__dirname, 'app/js/widget/jquery_util'),
            common:path.resolve(__dirname, 'app/js/widget/jquery_common')
        }
    }
};